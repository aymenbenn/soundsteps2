...
import imageB from '../assets/b1.png';
import imageC from '../assets/b2.png';
import imageD from '../assets/b3.png';
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Card 1 */}
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 border border-gray-100 border-t-4 border-t-primary relative overflow-hidden">
            <img
              src={imageB}
              alt="Waiting time illustration"
              className="w-60 md:w-72 h-60 md:h-72 object-cover rounded-xl mb-6 shadow-lg"
            />
          ...
          {/* Card 2 */}
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 border border-gray-100 border-t-4 border-t-accent relative overflow-hidden">
            <img
              src={imageC}
          ...
          {/* Card 3 */}
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 border border-gray-100 border-t-4 border-t-yellow relative overflow-hidden">
            <img
              src={imageD}
